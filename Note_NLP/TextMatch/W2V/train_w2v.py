...
可直接下载中文词向量：https://github.com/Embedding/Chinese-Word-Vectors
"""
#%%
...
class TrainWord2Vec:
    ...
    def __init__(self, data='corpus.txt', num_features=300, min_word_count=10, context=5, incremental=False,
                 old_path=None):
        """
        定义变量
        :param data: 用于训练的语料
        ...
        """
        self.data = os.path.join(DATA_HOME, data)
    ...
    def main(self):
        ...
        model.save(os.path.join(DATA_HOME, "token_vec_300.model"))
        model.wv.save_word2vec_format(os.path.join(DATA_HOME, "token_vec_300.bin"), binary=False)
#%%
