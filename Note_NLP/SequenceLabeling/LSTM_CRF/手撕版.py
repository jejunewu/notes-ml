...
class BiLSTM_CRF(nn.Module):
    ...
    def _get_lstm_features(self, words):
        ...
        # 把LSTM输出的隐状态张量去掉batch维 (dim=1)，然后降维到tag空间
    ...
    def _to_tensor(self, words, to_ix):
        """
        将words/tags序列数值化，即: 映射为相应下标序列张量
        Args:
            words
        """
...
if __name__ == '__main__':
    ...
    with torch.no_grad():  # 这里用了第一条训练数据(而非专门的测试数据)，仅作教学演示
        ...
        print([tag2ix[tag] for tag in "B I I I O O O B I O O".split()])