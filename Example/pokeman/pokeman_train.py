...
from Example.pokeman.pokeman import load_pokeman, load_csv
import os
...
batchsz = 32
root = r'C:\Users\ThinkPad\Desktop\pokeman'
images, labels, table = load_pokeman(root, mode='train')
print('images:', len(images), images)
print('labels:', len(labels), labels)
print('table:', table)

db_train = tf.data.Dataset.from_tensor_slices((images, labels)).shuffle(1000).map(preprocess).batch(32)
images_val, labels_val, table = load_pokeman(root, mode='val')
...
from Example.pokeman import ResNet
